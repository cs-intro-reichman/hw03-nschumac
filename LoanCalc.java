...
public class LoanCalc {
    ...
    /**
     * Gets the loan data and computes the periodical payment. Expects to get three
     * command-line arguments: sum of the loan (double), interest rate (double, as a
     * percentage), and number of payments (int).
     */
     ...
     * to 0. Given: the sum of the loan, the periodical interest rate (as a
     * percentage), the number of periods (n), and epsilon, a tolerance level.
     */
     ...
     * that will bring the ending balance of a loan close to 0. Given: the sum of
     * theloan, the periodical interest rate (as a percentage), the number of
     ...
     * periodical interest rate (as a percentage), the number of periods (n), and
